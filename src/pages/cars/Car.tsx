            ...
            <div className="details px-4 py-2">
                <div className="header flex justify-between mb-4 items-center border-b pb-2 border-b-gray-300/75">
                    <div className="flex items-center justify-center gap-x-4">
                        ...
                        {!editable && (
                            car.isAvailable ? (
                                <span className="bg-green-600 text-white font-bold py-1 px-2 rounded-full shadow-lg shadow-green-400">Available</span>
                            ) : (
                                <span className="bg-red-600 text-white font-bold py-1 px-2 rounded-full shadow-lg shadow-red-400">Rented</span>
                            )
                        )}
                        {editable && (
                ...
                <div>
                    ...
                    <div>
                        ...
                        <InfoRow
                            ...
                            Icon2={CarFront}
                            onChange2={(e) => handleInputChange("engineDisplacement", e.target.value)}
                        />
                        <InfoRow
                            editable={editable}
                            label1="Power"
                        ...
                        <InfoRow
                            ...
                            Icon2={Ratio}
                            onChange2={(e) => handleInputChange("specification", e.target.value)}
                        />
                    </div>
                </div>
            </div>
...
const InfoRow = ({ label1, onChange1, onChange2, value1, label2, value2, editable = false, Icon1, Icon2 }: InfoRowType) => {
    return (
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-x-14 gap-y-16`}>
            <label htmlFor={label1} className="w-full flex items-center justify-between bg-gray-50/50 my-2 p-2 rounded-md">
                ...
                <input type="text" id={label1} onChange={onChange1} name={label1} placeholder={value1} disabled={!editable} className={`placeholder:text-black border py-1 rounded-md px-2 outline-none focus:border-black transition ease-in-out ${editable ? "placeholder:font-normal border-gray-400" : "placeholder:font-bold border-transparent"}   disabled:bg-transparent text-right bg-transparent`} />
            </label>
            ...
            <label htmlFor={label2} className="w-full flex items-center justify-between bg-gray-50/50 my-2 p-2 rounded-md">
                ...
                <input type="text" id={label2} onChange={onChange2} name={label2} placeholder={value2} disabled={!editable} className={`placeholder:text-black border py-1 rounded-md px-2 outline-none focus:border-black transition ease-in-out ${editable ? "placeholder:font-normal border-gray-400" : "placeholder:font-bold border-transparent"}   disabled:bg-transparent text-right bg-transparent`} />
            </label>
